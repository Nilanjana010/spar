...
#Helper class to print to BOTH terminal and file
class Tee(object):
...
INPUT_DIR = "in_graph_files_eval"
PLOT_DIR = "plots_eval_gemma"
SPARSE_DIR = "sparsified_eval_gemma"
...
def getincorrectlabel(json_data):
    ...
    #[1] is the second most likely label (the "foil")
...
#modify for llama later (in_graph_files_full_eval_llama)
exponents = [0.9]
    ...
    for ind_file in os.listdir(sub_dir):
        ...
        with open(log_file_path, 'w') as f:
                with contextlib.redirect_stdout(Tee(sys.stdout, f)):
                        ...
                        output_json = os.path.join("sparsified_eval_gemma", ind_file + "_sparsified" + '.json')
