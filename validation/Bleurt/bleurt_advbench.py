...
gemma_dict = {}
for gem_file in os.listdir("validate_gemma_advbench"):
    print(gem_file)
    with open(os.path.join("validate_gemma_advbench", gem_file), "rb") as f:
...
llama_dict = {}
for lla_file in os.listdir("validate_llama_advbench"):
    print(lla_file)
    with open(os.path.join("validate_llama_advbench", lla_file), "rb") as f:
...
with open("data_advbench_gemma_bleurt_scores", "wb") as f:
            pickle.dump(gemma_dict, f)
with open("data_advbench_llama_bleurt_scores", "wb") as f:
